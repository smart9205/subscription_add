...
$(window).on('load', function () {
  ...
  var $wifiStrokeColor2 = '#51e5a8';
  var wifichart = $("#myWiFiChart");
  ...
  //var $wifiChannel24Chart = document.querySelector('#wifi-channel-24-chart');
  ...
  var wifi24chart = new ApexCharts(document.querySelector("#wifi-24channel-chart"), wifi24chartOptions);
  wifi24chart.render();

  var wifi50chartOptions = {
    chart: {
      height: 245,
      type: 'radialBar',
      sparkline: {
  ...
  var wifi50chart = new ApexCharts(document.querySelector("#wifi-50channel-chart"), wifi50chartOptions);
  wifi50chart.render();
