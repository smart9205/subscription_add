...
$(function () {
  ...
  if (flatPicker.length) {
    ...
    flatPicker.each(function () {
      $(this).flatpickr({
        mode: 'range',
        defaultDate: ['2021-05-01', '2021-05-14']
      });
    });
  }
  ...
  var areaChartEl = document.querySelector('#line-area-chart'),
    areaChartConfig = {
      ...
      series: [
        {
          name: 'Downloads (TB)',
          data: [170, 220, 90, 170, 130, 160, 140, 240, 220, 180, 270, 280, 375, 220]
        },
        {
          name: 'Uploads (TB)',
          data: [90, 140, 70, 110, 80, 100, 90, 180, 160, 140, 200, 220, 275, 160]
        }
      ],
      xaxis: {
        categories: [
  ...
  var columnChartEl = document.querySelector('#column-chart'),
    columnChartConfig = {
      ...
      series: [
        {
          name: 'Online',
          data: [90, 120, 55, 100, 80, 125, 175, 70, 88, 180, 120, 80, 90,100]
        },
        {
          name: 'Offline',
          data: [85, 100, 30, 40, 95, 90, 30, 110, 62, 20, 40, 60, 30,60]
        }
      ],
      xaxis: {
        categories: ['1/05', '2/05', '3/05', '4/05', '5/05', '6/05', '7/05', '8/05', '9/05', '10/05', '11/05', '12/05', '13/05', '14/05']
      },
      fill: {
        opacity: 1
      },
